...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="500" viewBox="0 0 1200 500" role="img" aria-labelledby="title desc">
  ...
  <desc id="desc">An ASCII portrait of Ritik beside software, cloud and security engineering profile information.</desc>
  <defs>
  ...
  <text x="600" y="181" class="role">SOFTWARE • CLOUD • SECURITY</text>
  <text x="600" y="222" class="key">ROLE</text><text x="770" y="222" class="value">Graduate Software Engineer</text>
  ...
  <text x="600" y="321" class="key">FOCUS</text><text x="770" y="321" class="value">Python • Cloud • Security</text>
  <text x="600" y="354" class="key">BUILDING</text><text x="770" y="354" class="value">Reliable, testable systems</text>
  <text x="600" y="387" class="key">STATUS</text><text x="770" y="387" class="online">● Open to graduate roles</text>
  <text x="600" y="425" class="prompt">$ mission</text>
  <text x="600" y="454" class="quote">“Build dependable software. Test the edges.”</text>
  <style>
